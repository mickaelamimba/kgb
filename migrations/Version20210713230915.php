 ...
 */
final class Version20210713230915 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE agents ADD CONSTRAINT FK_9596AB6EB6A5D0EA FOREIGN KEY (agent_specialties_id) REFERENCES specialties (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
