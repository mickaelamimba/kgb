 ...
 */
final class Version20210713231105 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE specialties ADD CONSTRAINT FK_410754B0D1433340 FOREIGN KEY (agents_specialties_id) REFERENCES agents (id)');
